...
public class telaGenio extends javax.swing.JFrame {
    ...
    public telaGenio() {
        initComponents();
        lblFrase.setText("<html>Vou pensar em um valor entre <b>1 e 5</b>. Tente advinhar!!<html>");
    }
    ...
    private void initComponents() {
        ...
        lblFrase.setFont(new java.awt.Font("Lucida Sans Unicode", 0, 14)); // NOI18N
        lblFrase.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblFrase.setText("Frase do Genio");
        lblFrase.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 50, 140, 70));
        ...
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 220, 50, -1));
        ...
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 280, -1, 40));
    ...
    // Como alterar a fonte de determinada variavel antes da exibição // 
